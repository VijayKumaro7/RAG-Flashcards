...
> Next.js 16 flashcard app with 50 cards across 10 RAG topics — chunking, embeddings, vector stores, RAGAS evaluation & more. Features 3D flip animation, keyboard shortcuts, category filtering, per-topic progress tracking, and review mode.
...
![Card Flipped](screenshots/02-card-flipped.png)

### Category Filter — Embeddings
![Category Filter](screenshots/03-embeddings-category.png)

### Progress Tracking — 12 Cards Known
![Progress Tracking](screenshots/04-progress-tracking.png)

### RAGAS Evaluation — Answer Side
![RAGAS Answer](screenshots/05-ragas-flipped.png)

### Review Mode — Unknown Cards Only
![Review Mode](screenshots/06-review-mode.png)
